document.addEventListener("DOMContentLoaded",function(){fetch("./data/faculty.json").then(a=>a.json()).then(a=>{faculty=a.faculty;let t=document.getElementById("faculty_box_team");facultyResult="",faculty.map((a,t)=>{let e=""==a.image?`<div class=${t%2==0?"empty_image_box1":"empty_image_box2"}></div>`:` <img  class="lazyload profile_img_team" data-src=${a.image}   />`;facultyResult+=`<div class="card">
              <div class="image_box">
               ${e}
              </div>
              <div class="text_team">
