document.addEventListener("DOMContentLoaded",function(){fetch("./data/publications.json").then(a=>a.json()).then(a=>{publications=a.publications;let e=document.getElementById("publications_box_team");publicationsResult="",publications.map((a,e)=>{let s=""==a.image?"<span></span>":`<img  class="lazyload image_research" data-src=${a.image}  />
            `;publicationsResult+=`
